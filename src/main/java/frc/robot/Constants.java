...
public final class Constants {
    ...
    public static class Button{
        public static final int flySpin         = 12;           //飛輪啟用
        ...
        public static final int turretleft      = 7;           //轉塔左
        public static final int turretRight     = 8;           //轉塔右
        public static final int arm_out         = 9;           //手臂出去
        public static final int arm_in          = 10;           //手臂進來
        public static final int intake_opp      = 11;          //進球反轉(包括送球三個馬達+吸球)
        // public static final int emergency_shoot = 12;          //緊急發射
        public static final int towerZero       = 13;          //轉塔歸零
        public static final int rackZero        = 14;          //齒條歸零
